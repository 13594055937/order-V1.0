<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:72:"C:\PHP\php11\WWW\order\order v1.0\order/Admin/home\view\login\index.html";i:1515577715;}*/ ?>
﻿<!DOCTYPE HTML>
<html>
<head>
<meta charset="utf-8">
		...
		<form class="form form-horizontal" action="index.html" method="post">
			...
			<div class="row cl">
				<div class="formControls col-xs-8 col-xs-offset-3" style="margin-left:29%;">
					<input name="" style="width:220px;" type="submit" class="btn btn-success radius size-L" value="&nbsp;登&nbsp;&nbsp;&nbsp;&nbsp;录&nbsp;">
				</div>
			</div>
		</form>
	</div>
