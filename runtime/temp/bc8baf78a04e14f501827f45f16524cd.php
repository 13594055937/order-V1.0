<?php if (!defined('THINK_PATH')) exit(); /*a:5:{s:72:"C:\PHP\php11\WWW\order\order-v1.0\order/Admin/user\view\power\index.html";i:1517475474;s:90:"C:\PHP\php11\WWW\order\order-v1.0\order/Admin/user\view\..\..\common\view\public\meta.html";i:1517551426;s:92:"C:\PHP\php11\WWW\order\order-v1.0\order/Admin/user\view\..\..\common\view\public\header.html";i:1515742683;s:90:"C:\PHP\php11\WWW\order\order-v1.0\order/Admin/user\view\..\..\common\view\public\menu.html";i:1517551457;s:92:"C:\PHP\php11\WWW\order\order-v1.0\order/Admin/user\view\..\..\common\view\public\footer.html";i:1517551415;}*/ ?>
<!DOCTYPE HTML>
<html>
<head>
    <meta charset="utf-8">
...
<section class="Hui-article-box">
	...
	<div class="Hui-article">
		<article class="cl pd-20">
			<div class="cl pd-5 bg-1 bk-gray"> <span class="l"> <a href="javascript:;" onclick="datadel()" class="btn btn-danger radius"><i class="Hui-iconfont">&#xe6e2;</i> 批量删除</a> <a class="btn btn-primary radius" href="javascript:;" onclick="power_add('poweradd')"><i class="Hui-iconfont">&#xe600;</i> 添加权限</a> </span> <span class="r">共有数据：<strong><?php echo $count; ?></strong> 条</span> </div>
			<div class="mt-10">
			<table class="table table-border table-bordered table-hover table-bg">
				...
				<?php if(is_array($list) || $list instanceof \think\Collection || $list instanceof \think\Paginator): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?>
					<tr class="text-c">
						...
						<td width="">
						<a title="编辑" href="javascript:;" onclick="member_edit('<?php echo url('poweredit',['id'=>$vo['id']]); ?>')" style="text-decoration:none"><i class="Hui-iconfont">&#xe6df;</i></a>&emsp;
