...
<article class="cl pd-20">
	...
	<input type="hidden" name="password" value="">
		<div class="row cl">
			<label class="form-label col-xs-4 col-sm-3"><span class="c-red">*</span>等级名：</label>
...
$(function(){
  ...
  // },
	...
	var options = {
	    url: "<?php echo url('engineerrate/addgrade'); ?>",
	    type: 'post',
