...
<aside class="Hui-aside">
    <div class="menu_dropdown bk_2">
        <dl id="menu-article">
            ...
            <dd>
                <ul>
                    <li><a data-href="<?php echo url('customer/customer/index'); ?>" data-title="客户列表" href="javascript:void(0)">客户列表</a></li>
            </ul>
        </dd>
    </dl>
        <dl id="menu-picture">
            ...
            <dd>
                <ul>
                    <li><a data-href="<?php echo url('engineer/engineer/index'); ?>" data-title="工程师列表" href="javascript:void(0)">工程师列表</a></li>
                    <li><a data-href="<?php echo url('engineer/engineertype/index'); ?>" data-title="工程师类别" href="javascript:void(0)">工程师类别</a></li>
                    <li><a data-href="<?php echo url('engineer/engineerrate/index'); ?>" data-title="工程师等级" href="javascript:void(0)">工程师等级</a></li>
        ...
        <dl id="menu-product">
            ...
            <dd>
                <ul>
                    <li><a data-href="<?php echo url('order/order/index'); ?>" data-title="工单列表" href="javascript:void(0)">工单列表</a></li>
            </ul>
        </dd>
    </dl>
        <!-- <dl id="menu-comments">
       ...
       <!--  <dl id="menu-member">
        ...
        <dl id="menu-tongji">
            ...
            <dd>
                <ul>
                    <li><a data-href="<?php echo url('company/company/index'); ?>" data-title="公司管理" href="javascript:void(0)">公司列表</a></li>
            </ul>
        </dd>
    </dl>
        <dl id="menu-system">
