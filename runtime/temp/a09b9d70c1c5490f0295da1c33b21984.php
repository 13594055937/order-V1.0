<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:75:"C:\PHP\php11\WWW\order\order-v1.0\order/Admin/user\view\power\poweradd.html";i:1517474720;s:90:"C:\PHP\php11\WWW\order\order-v1.0\order/Admin/user\view\..\..\common\view\public\meta.html";i:1517551426;s:92:"C:\PHP\php11\WWW\order\order-v1.0\order/Admin/user\view\..\..\common\view\public\footer.html";i:1517551415;}*/ ?>
<!DOCTYPE HTML>
<html>
<head>
    <meta charset="utf-8">
...
<article class="cl pd-20">
	...
	<div class="row cl">
			...
			<div class="formControls col-xs-8 col-sm-9">
				<input type="text" class="input-text" value="" placeholder="3到15位字符由字母开头、数字组合" id="" name="name">
			</div>
		</div>
		<div class="row cl">
			<label class="form-label col-xs-4 col-sm-3"><span class="c-red">*</span>URL：</label>
			<div class="formControls col-xs-8 col-sm-9">
				<input type="text" class="input-text" value="" placeholder="2到17位字符组合" id="username" name="url">
			</div>
		</div>
		<div class="row cl">
			<label class="form-label col-xs-4 col-sm-3"><span class="c-red">*</span>描述：</label>
			<div class="formControls col-xs-8 col-sm-9">
				<input type="text" class="input-text" value="" placeholder="6到17位字符由字母、数字及英文符号组合" name="bewrite">
			</div>
		</div><br>
